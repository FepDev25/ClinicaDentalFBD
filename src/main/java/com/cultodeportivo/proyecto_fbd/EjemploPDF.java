...
public class EjemploPDF {
    ...
    public EjemploPDF(FacturaCabecera cabecera) {
    ...
    public void generarPDF() {        
        ...
        try {
            ...
            g2d.drawRect(15 + columnWidth, 295, columnWidth, 300); 
            g2d.drawRect(15 + columnWidth * 2, 295, columnWidth, 300); 
            g2d.drawRect(15 + columnWidth * 3, 295, columnWidth, 300);
            g2d.drawRect(15 + columnWidth * 4, 295, columnWidth, 300); 
            g2d.drawRect(15 + columnWidth * 5, 295, columnWidth, 300); 
            
            // Textos de encabezado
            Font serv = new Font("Tahoma", Font.PLAIN, 12);
            int inicial = 308;
            g2d.setColor(negro);
            g2d.drawString("Servicio", 20, inicial);
            g2d.drawString("Precio", 15 + columnWidth + 5, inicial);
            g2d.drawString("Cantidad", 15 + columnWidth * 2 + 5, inicial);
            g2d.drawString("Subtotal", 15 + columnWidth * 3 + 5, inicial);
            g2d.drawString("IVA", 15 + columnWidth * 4 + 5, inicial);
            g2d.drawString("Total", 15 + columnWidth * 5 + 5, inicial);
            ...
            for(int i = 0; i<detalles.size();i++){
                ...
                g2d.drawString(String.valueOf(detalle.getServicio().getSerPrecio()), 15 + columnWidth + 5, inicial);
                g2d.drawString(String.valueOf(detalle.getDetCantidad()), 15 + columnWidth * 2 + 5, inicial);
                g2d.drawString(String.valueOf(detalle.getDetSubtotal()), 15 + columnWidth * 3 + 5, inicial);
                g2d.drawString(String.valueOf(detalle.getDetIva()), 15 + columnWidth * 4 + 5, inicial);
                g2d.drawString(String.valueOf(detalle.getDetTotal()), 15 + columnWidth * 5 + 5, inicial);
            }
            
            // Subtotales, IVA y Total
            g2d.drawString("Subtotal", 15 + columnWidth * 4 + 5, 550);
            g2d.drawString("IVA", 15 + columnWidth * 4 + 5, 570);
            g2d.drawString("Total", 15 + columnWidth * 4 + 5, 590);
            
            g2d.drawString(cabecera.getCabSubtotal()+"", 15 + columnWidth * 5 + 5, 550);
            g2d.drawString(cabecera.getCabTotalIva()+"", 15 + columnWidth * 5 + 5, 570);
            g2d.drawString(cabecera.getCabTotal()+"", 15 + columnWidth * 5 + 5, 590);
